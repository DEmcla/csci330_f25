...
echo "------------------------------------"
check_dir "modules"
check_dir "modules/module-01_ch1/assignment-template"
check_file "modules/module-01_ch1/assignment-template/CMakeLists.txt"
check_file "modules/module-01_ch1/assignment-template/src/main.cpp"
