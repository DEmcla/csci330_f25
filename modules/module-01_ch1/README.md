...
2. **🛠️ [VS Code + C++ Mastery Tutorial](tutorial-vscode-mastery.md)** ⭐ **(Optional but Recommended)** - Essential development workflow (30-45 min)
...
1. **🛠️ Try [VS Code Mastery Tutorial](tutorial-vscode-mastery.md)** - Struggling with VS Code, debugging, or Git? (30-45 min)
